...
G_DEFINE_TYPE(ipc3270Response, ipc3270Response, G_TYPE_OBJECT)

/*--[ Implement ]------------------------------------------------------------------------------------*/

static void ipc3270Response_finalize(GObject *object) {
...
static void ipc3270Response_class_init(ipc3270ResponseClass *klass) {

	debug("%s",__FUNCTION__);

	GObjectClass *object_class;
	object_class = G_OBJECT_CLASS (klass);
	object_class->finalize = ipc3270Response_finalize;
